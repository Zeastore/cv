...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/Zeastore/cv/main/cuk/allow| grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
    echo -e "\e[32mSTATUS SCRIPT AKTIF...\e[0m"
    else
    echo -e "\e[31mSCRIPT ANDA EXPIRED!\e[0m";
    echo -e "\e[31mRENEW IP CONTACT ADMIN#\e[0m"
    exit 0
fi
}
...
echo -e "\e[31mDaftar IP Contact ADMIN #\e[0m"
exit 0
fi
clear 
